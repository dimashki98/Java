$(document).ready(function () {
    ...
    function scrollToBottom() {
        if (!isFrozen) {
            messagesContainer.stop().animate({ scrollTop: messagesContainer.prop('scrollHeight') }, 300);  // إضافة حركة سلسة
        }
    }
    ...
    unfreezeButton.on('click', function () {
        ...
        // إضافة التمرير السلس عند إلغاء التجميد
        messagesContainer.stop().animate({ scrollTop: messagesContainer.prop('scrollHeight') }, 500);  // تحديد مدة لتأثير السلاسة
    });
});
