...
$(() => {
  ...
  function showBirthdayCelebration() {
    ...
    Swal.fire({
      title: '🎂 كل عام وأنتِ بخير غزل! 🎂',
      html: `
        <div style="text-align: center; padding: 15px;">
          <div style="font-size: clamp(18px, 4vw, 24px); margin-bottom: 15px;">
            ✨ <span class="birthday-text">عيد ميلاد سعيد يا أجمل غزل</span> ✨
          </div>
          ...
          <iframe id="birthday-video" 
                  src="https://www.youtube.com/embed/ZTcgVajcXAI?autoplay=1&mute=0&loop=1&playlist=ZTcgVajcXAI&controls=1&showinfo=0&rel=0&modestbranding=1&start=0&enablejsapi=1" 
                  frameborder="0" 
          ...
          <p style="font-size: clamp(12px, 2.5vw, 14px); color: #c2185b; margin-top: 10px; font-style: italic;">
            🎵 أغنية خاصة لأجمل غزل في الدنيا 🎵
          </p>
        </div>
      `,
