            ...
            if (mutation.type === 'childList') {
                $(mutation.addedNodes).each(function () {
                    ...
                    if ($(this).hasClass('uzr') && $(this).hasClass('d-flex') && !$(this).hasClass('processed')) {
                        ...
                        const customStyles = {
                            "ب.ه.إكس": "https://up6.cc/2025/03/174315747223481.jpg", // تصميم B.H.X (بسمة)
                            "ي.د.إكس": "https://up6.cc/2025/03/17431574722633.jpg",  // تصميم Y.D.X (ياسو أو ياسمين)
                            "مريم": "https://up6.cc/2025/03/174315747225292.jpg",   // تصميم مَريم
                            "ياسمين": "https://up6.cc/2025/03/17431574722633.jpg"   // تصميم Y.D.X (ياسو أو ياسمين)
                        };

                        // التحقق من تطابق النصوص مع الأسماء المحددة
                        Object.keys(customStyles).forEach(name => {
                            // نبحث عن الأسماء بشكل غير حساس لحالة الأحرف
                            if (topicText.includes(name.toLowerCase()) || messageText.includes(name.toLowerCase())) {
